    ...
    <div>
        ...
        <div className={style.header}>
            <div className={style.header_color}>
                <div className={style.header_cont}>
                    ...
                    <p><b>Africrafted,</b> we are here for you.</p>  
                </div>
            </div>
        </div>
        <div className={style.contact_form}>
          <div className={style.address}>
            ...
            <p>P.O.BOX 1234</p>
            <p>Lusaka, Zambia</p>
            <p><BsTelephone /> Call Us +260 7777 30003</p> 
            <p><BsWhatsapp /> Whatsapp +260 7777 30003</p>
            <BsEnvelope /> Email: <a href="mailto:africrafted@gmail.com">africrafted@gmail.com</a>
          </div>
          <div className="map">
            <h2>Map</h2>
            <p>You can locate us on this google map</p>
          </div>
            <form>
